...
const getFonts = assetsUrl => {
    ...
    @font-face {
      ...
      src: font-url('${
			assetsUrl
		}/OpenSans-Light/OpenSans-Light.eot?#iefix') format('embedded-opentype'),
           local('Open Sans Light'),
           local('OpenSans-Light'),
           url('${
				assetsUrl
			}/OpenSans-Light/OpenSans-Light.woff') format('woff'),
           url('${
				assetsUrl
			}/OpenSans-Light/OpenSans-Light.ttf') format('truetype'),
           url('${
				assetsUrl
			}/OpenSans-Light/OpenSans-Light.svg#OpenSans') format('svg');
    }
    ...
    @font-face {
      ...
      src: url('${
			assetsUrl
		}/OpenSans/OpenSans.eot?#iefix') format('embedded-opentype'),
           local('Open Sans'),
           local('OpenSans'),
    ...
    @font-face {
      ...
      src: url('${
			assetsUrl
		}/OpenSans-Semibold/OpenSans-Semibold.eot?#iefix') format('embedded-opentype'),
           local('Open Sans Semibold'),
           local('OpenSans-Semibold'),
           url('${
				assetsUrl
			}/OpenSans-Semibold/OpenSans-Semibold.woff') format('woff'),
           url('${
				assetsUrl
			}/OpenSans-Semibold/OpenSans-Semibold.ttf') format('truetype'),
           url('${
				assetsUrl
			}/OpenSans-Semibold/OpenSans-Semibold.svg#OpenSans') format('svg');
    }
    ...
    @font-face {
      ...
      src: url('${
			assetsUrl
		}/OpenSans-Bold/OpenSans-Bold.eot?#iefix') format('embedded-opentype'),
           local('Open Sans Bold'),
           local('OpenSans-Bold'),
           url('${assetsUrl}/OpenSans-Bold/OpenSans-Bold.woff') format('woff'),
           url('${
				assetsUrl
			}/OpenSans-Bold/OpenSans-Bold.ttf') format('truetype'),
           url('${
				assetsUrl
			}/OpenSans-Bold/OpenSans-Bold.svg#OpenSans') format('svg');
    }`;
};
