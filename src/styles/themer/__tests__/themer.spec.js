...
it('should warn when no config is set', () => {
    ...
    expect(
        console.warn.calledWith(
            'React-able theme error: No themeConfig defined. Please use Themer template: ',
            themeTemplate
        )
    ).toBeTruthy();
...
it('should warn and clean config on full config set', () => {
    ...
    expect(
        console.warn.calledWith(
            'React-able theme error: "madness" not a valid config key. This value will not be set. Please use Themer template: ',
            themeTemplate
        )
    ).toBeTruthy();
    expect(
        console.warn.calledWith(
            'React-able theme error: "stuff" not a valid config section. These values will not be set. Please use Themer template: ',
            themeTemplate
        )
    ).toBeTruthy();
...
it('should add listener to list', () => {
    const listener = theme => console.log(theme);
